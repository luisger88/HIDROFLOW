...
const rutaSalida = "00_ADMIN/bitacora/OT-0281/OT-0281B_validacion_aislada_helper_bloque_volumen_referencia_expediente.md";

fs.mkdirSync("00_ADMIN/bitacora/OT-0281", { recursive: true });
fs.writeFileSync(rutaSalida, salidaMarkdown.join("\n"), "utf8");

console.log("VALIDACION_OT_0281_HELPER_VOLUMEN_REFERENCIA_COMPLETADA");
