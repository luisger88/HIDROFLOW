...
const resumen = {
  ...
  salidaRealMetodoRacionalCorregida: controles.every((control) => control.aprobado),
...
if (resumen.salidaRealMetodoRacionalCorregida) {
...
salidaMarkdown.push("");
salidaMarkdown.push(
  resumen.salidaRealMetodoRacionalCorregida
    ...
    : "La corrección del bloque `Método Racional — contraste global independiente` requiere revisión antes de avanzar."
);
salidaMarkdown.push("");
...
salidaMarkdown.push(
  resumen.salidaRealMetodoRacionalCorregida
    ...
    : "`OT-0321 — Revisión adicional corrección Método Racional como contraste global independiente`"
);
...
console.log("VALIDACION_OT_0320_METODO_RACIONAL_CORREGIDO_COMPLETADA");
