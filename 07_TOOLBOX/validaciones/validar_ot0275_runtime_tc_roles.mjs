...
function prepararModuloTemporal() {
  const carpetaTemporal = fs.mkdtempSync(path.join(os.tmpdir(), "ot0275-hidroflow-"));
...
const controles = [
  ...
  {
    id: "firma_constructor_incluye_tr_diseno",
    descripcion: "Firma del constructor incluye trDisenoActivoExpediente = null",
    aprobado: fuenteExpediente.includes("trDisenoActivoExpediente = null,")
  },
  {
    id: "variable_documental_tr_declarada",
    descripcion: "Variable trDisenoActivoExpedienteDocumental declarada una sola vez",
    ocurrencias: contarOcurrencias(fuenteExpediente, "const trDisenoActivoExpedienteDocumental"),
    aprobado: contarOcurrencias(fuenteExpediente, "const trDisenoActivoExpedienteDocumental") === 1
  },
  {
    id: "salida_real_pasa_tr_documental",
    descripcion: "Salida real pasa trDisenoActivoExpedienteDocumental a la función auxiliar",
    aprobado: fuenteExpediente.includes("trDisenoActivoExpediente: trDisenoActivoExpedienteDocumental")
  },
  {
    ...
    aprobado:
      ...
      !bloqueSecciones.includes("trDisenoActivoExpediente")
  },
  {
...
const resumen = {
  ...
  runtimeCorregido:
    ...
    controles.find((control) => control.id === "constructor_principal_genera_salida")?.aprobado === true,
...
const salidaMarkdown = [
  "# OT-0275B — Revalidación runtime salida real helper Tiempo de concentración y roles Tc",
  "",
  "## Resumen",
  "",
  "```json",
...
salidaMarkdown.push("");
salidaMarkdown.push("- El runtime del constructor principal fue evaluado mediante módulo temporal.");
salidaMarkdown.push("- La variable `trDisenoActivoExpedienteDocumental` elimina el error runtime detectado en OT-0273.");
...
salidaMarkdown.push("");
salidaMarkdown.push(
  resumen.runtimeCorregido && resumen.acopleSalidaRealValidado
    ? "El runtime y el acople de salida real del helper Tc roles quedan revalidados."
    : "El runtime o el acople requieren corrección adicional antes de estabilizar el bloque."
);
salidaMarkdown.push("");
...
salidaMarkdown.push(
  resumen.runtimeCorregido && resumen.acopleSalidaRealValidado
    ...
    : "`OT-0276 — Corrección adicional runtime/acople bloque Tiempo de concentración y roles Tc`"
);

const rutaSalida = "00_ADMIN/bitacora/OT-0275/OT-0275B_revalidacion_runtime_salida_real_helper_tiempo_concentracion_roles_tc.md";

fs.mkdirSync("00_ADMIN/bitacora/OT-0275", { recursive: true });
...
console.log("VALIDACION_OT_0275_RUNTIME_TC_ROLES_COMPLETADA");
