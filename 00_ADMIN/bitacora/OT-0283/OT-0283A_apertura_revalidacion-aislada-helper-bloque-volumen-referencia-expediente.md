# OT-0283A — Revalidación aislada helper bloque Volumen de referencia del expediente

## Objetivo

Revalidar en aislamiento el helper puro documental construirBloqueVolumenReferenciaExpediente después de la corrección textual OT-0282, comprobando exportaciones, salida string[], título opcional, fallbacks, formato documental, tokens prohibidos, ausencia de referencias prohibidas en fuente, no mutación de entradas y build aprobado, sin acoplarlo al constructor principal ni modificar código funcional.
...
- Crear únicamente documentación y script de revalidación OT-0283.
