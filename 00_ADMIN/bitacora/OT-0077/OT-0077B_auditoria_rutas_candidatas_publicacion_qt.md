...
Fecha: 2026-06-12 22:48:22

## Estado base

- Rama: ot-0077-ruta-publicacion-futura-series-qt.
- OT-0077A cerrada en commit 4a15a9c.
- Main base: e93b859, posterior a OT-0076.
- Alcance: auditoría documental/código, sin cambios funcionales.

## Objetivo

Auditar en código las rutas candidatas para publicar series temporales Q(t) reales por método, sin recalcular hidrogramas, sin inventar puntos tiempo-caudal y sin alterar Qpico, tPico, volTotal ni Q(t).

## Rutas candidatas auditadas
...
## Evidencia en services/hidrogramas
...
Esta auditoría busca determinar si la ruta viable es publicar desde motor, contexto exportable, adaptador sobre objetos existentes o retención futura de series temporales.

## Restricciones

- No modificar ComparadorMultiMetodo.jsx en OT-0077B.
...
OT-0077B queda completa cuando exista auditoría versionada de rutas candidatas de publicación Q(t), sin cambios funcionales sobre la aplicación.
