...
Auditar en código el punto donde se genera, transforma, resume o pierde la serie temporal Q(t), para determinar si la serie existe antes de llegar al comparador o si el flujo actual conserva únicamente resultados resumen.
...
Esta auditoría debe permitir distinguir si Q(t) se genera y se pierde antes del comparador, o si actualmente solo se conservan resultados resumen como Qpico, tPico y volTotal.

## Restricciones

- No modificar ComparadorMultiMetodo.jsx en OT-0077E.
...
OT-0077E queda completa cuando exista auditoría focal versionada del punto de generación o pérdida de Q(t), sin cambios funcionales sobre la aplicación.
