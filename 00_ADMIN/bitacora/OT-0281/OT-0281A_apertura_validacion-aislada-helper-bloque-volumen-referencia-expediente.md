# OT-0281A — Validación aislada helper bloque Volumen de referencia del expediente

## Objetivo

Validar en aislamiento el helper puro documental construirBloqueVolumenReferenciaExpediente, comprobando exportaciones, salida string[], título opcional, fallbacks, formato documental, tokens prohibidos, no mutación de entradas y build aprobado, sin acoplarlo al constructor principal ni modificar código funcional.
...
- Crear únicamente documentación y script de validación OT-0281.

## Próximo frente recomendado

OT-0282 — Decisión integración helper bloque Volumen de referencia del expediente
