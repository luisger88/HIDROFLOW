# OT-0268A — Decisión integración helper bloque Tiempo de concentración y roles Tc del expediente

## Objetivo

Decidir si procede integrar el helper construirBloqueTiempoConcentracionRolesTcExpediente al constructor del expediente hidrológico mínimo, con base en la validación aislada aprobada OT-0267, sin acoplar todavía ni modificar código funcional.
...
- Crear únicamente documentación OT-0268.
