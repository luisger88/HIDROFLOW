# OT-0302A — Decisión estabilización bloque Escenario Q-Tr activo del expediente

## Objetivo

Documentar la decisión de estabilizar el bloque Escenario Q-Tr activo — control de trazabilidad del expediente hidrológico mínimo, con base en la implementación, validación aislada, decisión de integración, diseño de acople, acople mínimo, validación del acople y revalidación de salida real aprobadas hasta OT-0301, sin modificar código funcional.
...
- No implementar acople adicional al constructor principal.
...
- Crear únicamente documentación OT-0302.
