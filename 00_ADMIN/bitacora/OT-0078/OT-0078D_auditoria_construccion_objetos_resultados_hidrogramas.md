...
- Alcance: auditoría focal de construcción de objetos resultados, sin cambios funcionales.

## Objetivo

Auditar dónde se construye el contenedor de resultados de hidrogramas que llega al comparador, identificando cómo se forman los objetos con Qpico, tPico y volTotal y por qué no incluyen una serie temporal Q(t) reconocible.

## Preguntas de auditoría

- Dónde se crea el objeto hidrogramas.
- Dónde se crea el arreglo resultados.
- Dónde se asignan Qpico, tPico y volTotal.
- Si existe serie temporal antes de construir resultados.
- Si la serie temporal se descarta antes de publicar al contexto.
- Si el objeto resultados solo fue diseñado para transportar resúmenes.
...
Esta auditoría busca localizar el punto donde los hidrogramas dejan de ser una posible serie temporal y pasan a ser objetos resumen con Qpico, tPico y volTotal.

## Restricciones

- No modificar ComparadorMultiMetodo.jsx en OT-0078D.
...
OT-0078D queda completa cuando exista auditoría versionada de construcción de objetos resultados de hidrogramas, sin cambios funcionales sobre la aplicación.
