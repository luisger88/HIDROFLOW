# OT-0287A — Validación acople helper bloque Volumen de referencia del expediente

## Objetivo

Validar el acople mínimo del helper puro documental construirBloqueVolumenReferenciaExpediente en el expediente hidrológico mínimo, comprobando import único, delegación de la función auxiliar, uso en salida real, eliminación del bloque inline antiguo, salida real sin tokens inválidos y build aprobado, sin corregir código funcional.
...
- Crear únicamente documentación y script de validación OT-0287.
