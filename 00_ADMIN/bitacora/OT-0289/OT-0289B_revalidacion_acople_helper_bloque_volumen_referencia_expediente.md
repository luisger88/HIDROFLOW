...
### entradas_documentales_explicitas_presentes
...
### variables_documentales_respaldo_presentes
...
- El acople del helper Volumen de referencia fue revalidado estructuralmente.
- La función auxiliar delega al helper validado.
- La salida real usa la función auxiliar con variables documentales de respaldo.
- El bloque inline antiguo no permanece en el constructor principal.
- La salida real conserva las líneas esperadas con valores documentales.
