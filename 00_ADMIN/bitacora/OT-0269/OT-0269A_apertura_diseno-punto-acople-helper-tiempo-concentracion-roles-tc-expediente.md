# OT-0269A — Diseño punto de acople helper Tiempo de concentración y roles Tc del expediente

## Objetivo

Diseñar el punto de acople seguro del helper construirBloqueTiempoConcentracionRolesTcExpediente dentro del constructor del expediente hidrológico mínimo, definiendo import, función auxiliar, frontera de sustitución y validaciones posteriores, sin modificar código funcional.
...
- Crear únicamente documentación OT-0269.
