...
### firma_constructor_incluye_tr_diseno
...
### variable_documental_tr_declarada
...
### salida_real_pasa_tr_documental
...
- El runtime del constructor principal fue evaluado mediante módulo temporal.
- La variable `trDisenoActivoExpedienteDocumental` elimina el error runtime detectado en OT-0273.
