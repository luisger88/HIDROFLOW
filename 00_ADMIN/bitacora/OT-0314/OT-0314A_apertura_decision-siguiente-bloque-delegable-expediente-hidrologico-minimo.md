# OT-0314A — Decisión siguiente bloque delegable del expediente hidrológico mínimo

## Objetivo

Definir documentalmente el siguiente bloque del expediente hidrológico mínimo que conviene delegar mediante helper puro, con criterios de bajo coste, alto valor documental, bajo riesgo funcional, trazabilidad institucional y continuidad con la arquitectura ya validada en los bloques Identificación, Parámetros hidrológicos base, Tiempo de concentración y roles Tc, Volumen de referencia, Escenario Q-Tr activo y Resumen Q-5 auditado, sin crear helper ni modificar código funcional en esta OT.
...
- No crear archivo funcional nuevo.
- No modificar validadores existentes.
- Crear únicamente documentación OT-0314.
- No crear script de validación en esta OT salvo que sea estrictamente documental.
...
OT-0315 — Diseño contractual del siguiente bloque delegable seleccionado del expediente hidrológico mínimo
