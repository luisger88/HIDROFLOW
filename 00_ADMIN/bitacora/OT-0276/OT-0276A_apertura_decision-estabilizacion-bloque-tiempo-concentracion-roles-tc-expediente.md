# OT-0276A — Decisión estabilización bloque Tiempo de concentración y roles Tc del expediente

## Objetivo

Documentar la decisión de estabilizar el bloque Tiempo de concentración y roles Tc del expediente hidrológico mínimo, con base en la revalidación runtime aprobada OT-0275, sin modificar código funcional ni emitir dictamen hidrológico.
...
- Crear únicamente documentación OT-0276.
