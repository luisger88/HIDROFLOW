# OT-0069B — Auditoría del punto de integración del adaptador qSeries

Fecha: 2026-06-12 19:01:52

## Estado base

- Rama: ot-0069-adaptador-no-invasivo-publicacion-qseries.
- OT-0069A cerrada en commit 1be8df4.
- Main base: 5e59baf, posterior a OT-0068.
- Alcance: auditoría documental/código, sin cambios funcionales.

## Objetivo

Identificar el punto seguro de integración para un adaptador puro de publicación qSeries, sin modificar hidroEngine.js, sin recalcular hidrogramas y sin alterar Qp, Tp, Volumen ni Q(t).
...
> 01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:138:  pendientes: metodos.filter(m => m.estadoImplementacion === "pendiente").length
  ...
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:144:    pagina: {
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:145:      minHeight: "100vh",
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:146:      padding: "22px",
...
> 01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:584:  const candidatos = Array.isArray(bruto)
  ...
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:592:  const nombreCatalogo = normalizarTexto(metodo.nombre);
...
> 01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:959:    const resultadoQ = obtenerResultadoQMetodo(metodo);
  ...
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1369:  <button
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1370:    type="button"
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1371:    style={{
> 01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1372:      ...estiloBotonFiltro(filtroTipo === "q"),
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1373:      opacity: bloqueoAdopcion ? 0.5 : 1,
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1374:      cursor: bloqueoAdopcion ? "not-allowed" : "pointer"
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1375:    }}
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1376:    onClick={() => {
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1377:      if (!bloqueoAdopcion) setFiltroTipo("q");
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1378:    }}
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1379:    disabled={bloqueoAdopcion}
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1380:    title={bloqueoAdopcion ? "Bloqueado por incoherencia hidrológica" : ""}
...
> 01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:1733:                ? obtenerResultadoQMetodo(metodoQ5PrincipalConsistencia)
  ...
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:2041:              Number.isFinite(areaKm2) && Number.isFinite(peTotalMm)
  01_APP\HIDROFLOW\src\components\ComparadorMultiMetodo.jsx:2042:                ? areaKm2 * peTotalMm * 1000
...
El punto candidato inicial para integración no invasiva es una capa de servicio puro en src/services/hidrogramas/, que reciba contextoBase?.hidrogramas y devuelva objetos normalizados según el contrato OT-0068E.

El comparador actualmente consume resultados de hidrogramas mediante obtenerResultadoQMetodo y extrae Qp, Tp y volumen. La integración futura no debe reemplazar esa lectura ni modificar el flujo existente; debe agregar una publicación auxiliar qSeries.

## Punto candidato de servicio
...
- No modificar ComparadorMultiMetodo.jsx en OT-0069B.
- No modificar HidroFlow.jsx en OT-0069B.
- No modificar hidroEngine.js.
- No recalcular hidrogramas.
- No alterar Qp, Tp, Volumen ni Q(t).
- No calcular todavía métricas De, W50, W25, pendientes ni asimetría.
- No generar PDF, Word ni mapas.

## Criterio de salida

OT-0069B queda completa cuando exista una auditoría versionada del punto de integración del adaptador qSeries, sin cambios funcionales sobre la aplicación.
